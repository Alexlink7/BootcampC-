...
console.log(`Абсолютное значение числа -10: ${Math.abs(-10)}`);
...
console.log(`Классическое математическое округление 4.5: ${Math.round(4.5)}`);
console.log(`Псевдослучайное число от 0 до 1 (единица не включается): ${Math.random()}`);

console.log(11 / 4);
console.log(Math.floor(11 / 4));
console.log(Math.round(11 / 4));
console.log(Math.trunc(11 / 4));
